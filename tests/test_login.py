...
@pytest.mark.xfail
@pytest.mark.parametrize("empty_username, empty_password, expected_error", [
        ("", "wrongpass", "Your username is empty!"),
        ("student", "", "Your password is empty!"),
    ])
def test_login_with_empty_fields(login_page, empty_username, empty_password, expected_error):
